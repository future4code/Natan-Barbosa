...
if (operacao !== undefined) {
    ...
    switch (operacao) {
        case 'somar':
            ...
            logSucesso(`O resultado da soma ${numero1} + ${numero2} é ${soma}`)
            break
        case 'subtrair':
            const subtracao = numero1 - numero2
            logSucesso(`O resultado da subtração ${numero1} - ${numero2} é ${subtracao}`)
            break
        case 'multiplicar':
            const multiplicacao = numero1 * numero2
            logSucesso(`O resultado da multiplicação ${numero1} x ${numero2} é ${multiplicacao}`)
            break
        case 'dividir':
            const divisao = numero1 / numero2
            logSucesso(`O resultado da divisão ${numero1} / ${numero2} é ${divisao}`)
            break
        default:
            logErro(`
